        ...
        <div className="overflow-x-hidden">
            ...
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="font-pollos">
                        ...
                        >
                            🍗 O Melhor Frango Frito de Albuquerque
                        </motion.span>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-blue-900/60 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/20 shadow-2xl p-6">
                                <div className="flex items-center justify-center px-6 pt-3">
                                    ...
                                    src={gusFring}
                                    alt="Gustavo Fring"
                                    className="w-full max-h-105 object-cover object-center rounded-2xl"
                                    />
                                </div>
                                <div className="mt-4 p-4 bg-white/10 rounded-2xl font-pollos">
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    >
                        <span className="text-yellow-500 text-sm font-bold uppercase tracking-widest font-pollos">Por que nos escolher?</span>
                        <h2 className="text-4xl font-black text-blue-900 mt-3 font-pollos">O que nos torna especiais</h2>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {features.map((f, i) => (
                            ...
                            >
                                ...
                                <h3 className="text-blue-900 font-pollos font-bold text-lg mb-3">{f.title}</h3>
                                <p className="text-gray-500 text-sm font-pollos leading-relaxed">{f.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-24 bg-blue-950 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        />
                        <div className="absolute top-6 right-6 bg-yellow-400 font-pollos text-blue-900 font-black px-4 py-2 rounded-full text-sm shadow-xl">
                            ⭐ Prato do Chefe
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.7 }}
                    >
                        <span className="text-yellow-400 text-sm font-bold uppercase tracking-widest font-pollos">Destaque da semana</span>
                        <h2 className="text-4xl font-black mt-3 mb-6 font-pollos">
                            Frango Frito<br />
                            <span className="text-yellow-400">Clássico LPH</span>
                        </h2>
                        <p className="text-white/70 leading-relaxed mb-8 font-pollos">
                  ...
                  <span className="w-5 h-5 rounded-full bg-yellow-400 flex items-center justify-center shrink-0">
                    <span className="text-blue-900 text-xs font-black">✓</span>
                        ...
                        <NavLink
                            to="/menu"
                            className="inline-flex items-center font-pollos gap-2 px-8 py-4 bg-yellow-400 text-blue-900 font-black rounded-full uppercase tracking-wider hover:bg-yellow-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-400/30 transition-all duration-300"
                        >
            ...
            <section className="py-24 bg-yellow-50">
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <span className="text-yellow-500 text-sm font-bold uppercase tracking-widest font-pollos">Depoimentos</span>
                        <h2 className="text-4xl font-black text-blue-900 mt-3 font-pollos">O que nossos clientes dizem</h2>
                    </motion.div>
            ...
            <section className="py-24 bg-yellow-400">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl font-black text-blue-900 mb-4 font-pollos">Pronto para experimentar?</h2>
                        <p className="text-blue-900/70 text-lg mb-10">Visite uma de nossas unidades ou peça pelo telefone agora mesmo.</p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <NavLink
                                to="/menu"
                                className="px-8 font-pollos py-4 bg-blue-900 text-white font-black rounded-full uppercase tracking-wider hover:bg-blue-800 hover:-translate-y-1 transition-all duration-300 shadow-xl"
                            >
                                Ver Cardápio
                            </NavLink>
                            <NavLink
                                to="/contact"
                                className="px-8 py-4 border-2 font-pollos border-blue-900/40 text-blue-900 font-bold rounded-full uppercase tracking-wider hover:border-blue-900 transition-all duration-300"
                            >
